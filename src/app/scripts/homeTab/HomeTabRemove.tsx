...
export interface IHomeTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IHomeTabRemoveProps extends ITeamsBaseComponentProps {

}

/**
 * Implementation of home remove page
 */
export class HomeTabRemove  extends TeamsBaseComponent<IHomeTabRemoveProps, IHomeTabRemoveState> {
